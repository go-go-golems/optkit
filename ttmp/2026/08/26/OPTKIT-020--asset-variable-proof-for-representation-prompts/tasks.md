...
- [ ] Register representations.summary_prompt as a sensitivity-aware artifact variable <!-- t:hfha -->
- [ ] Implement old/new artifact materialization and side-by-side prompt diff authoring <!-- t:itw1 -->
- [ ] Compute and display the truthful upstream recomputation bill <!-- t:wq1k -->
- [ ] Implement a bounded server preview for one selected chunk <!-- t:zted -->
