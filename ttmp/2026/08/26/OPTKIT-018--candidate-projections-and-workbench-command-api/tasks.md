...
- [ ] Project structured candidate intent and mutation summaries from sealed campaign facts <!-- t:pfot -->
- [ ] Expose the current optimization catalog for authoring <!-- t:hvy2 -->
- [ ] Define an application command service for compile preview and seal operations <!-- t:29wr -->
- [ ] Add HTTP adapters without moving business logic into handlers <!-- t:grau -->
