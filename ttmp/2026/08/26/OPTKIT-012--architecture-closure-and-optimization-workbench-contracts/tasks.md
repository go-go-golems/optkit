...
- [ ] Review and accept ADRs for aggregate configuration, catalog/bindings, value schemas, candidate identity, provenance, and API boundaries <!-- t:dwt5 -->
- [ ] Approve concrete Go contracts for Catalog, Bindings, PipelineConfig, CompileProposal, and SealProposal <!-- t:sqdx -->
- [ ] Choose the v1 manifest and store compatibility policy before implementation <!-- t:limu -->
