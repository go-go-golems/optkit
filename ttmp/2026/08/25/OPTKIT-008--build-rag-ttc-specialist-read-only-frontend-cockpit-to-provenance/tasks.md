...
- [x] Scaffold apps/specialist/web (Vite + React + TS + RTK Query + vitest + MSW) with same-origin dev proxy <!-- t:1ugd -->
- [x] Define v1 API types and fixture-derived test data <!-- t:6oo4 -->
- [x] Build monochrome macos1 design system (tokens, panels, dither patterns, a11y focus states) <!-- t:vahi -->
- [x] Campaign cockpit screen with integrity, budget, episodes, arm/estimate selection <!-- t:h416 -->
- [x] Comparison view: metrics, config diff, invalidation plan with direct vs transitive distinction <!-- t:8eyo -->
